...
//таблица прерываний
#define IRQ_ENMI 0 //немаскируемое внешнее прерывание
#define IRQ_PERE 2 //немаскируемое исключение в аппаратной части
#define IRQ_PRGE 3 //немаскируемое программное исключение
...
//функция для установки пользовательского обработчика прерываний
void set_irq_vector(IRQ_HANDLER function, int irq_number);
//функция для установки маски прерываний
void asm_setl_MSKR();
//функция для получения текущей маски прерываний
int asm_getl_MSKR();
#endif

...
//Установка периода счетчика
#define TIM_CNT(VALUE, TIM, CH) TIM->CNT##CH = VALUE
//Очищение бита прерывания регистра управления

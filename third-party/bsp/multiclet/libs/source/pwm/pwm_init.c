#include "pwm.h"
/**
  * @brief  Инициализация PWM в соответствии с параметрами, заданными в PWM_InitStruct
  (Пользователь самостоятельно конфигурирует порты ввода-вывода).
  * @param  PWM_InitStruct : указатель на структуру PWM_InitTypeDef, которая
  *   содержит конфигурацию PWM.
  * @retval Нет
  */

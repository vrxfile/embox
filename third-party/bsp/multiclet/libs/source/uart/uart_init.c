#include "uart.h"
/**
  * @brief  Инициализация UART в соответствии с параметрами, заданными в UART_InitStruct
  ...
  * @param  USART_InitStruct : указатель на структуру USART_InitTypeDef, которая
  *   содержит конфигурацию для выбранного номера UART.
  * @retval Нет
  */

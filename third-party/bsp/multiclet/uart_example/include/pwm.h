...
//macro for pwm
//Проверка регистра сравнения канала channel_number на выработку прерывания по достижения счетчиком значения регистра сравнения(0 - нет прерывания;1 - есть прерывание)
#define PWM_INT_CH(CH_NUM) (PWM->INT & (1 << CH_NUM)? 1 : 0)

//prototypes
//Инициализация ШИМ, сконфигурированного структурой PWM_InitStruct

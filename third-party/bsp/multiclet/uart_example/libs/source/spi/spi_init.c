#include "spi.h"
/**
  * @brief  Инициализация SPI в соответствии с параметрами, заданными в SPI_InitStruct
  (Пользователь самостоятельно конфигурирует порты ввода-вывода).
  * @param  SPI : Выбор необходимого номера SPI. 
  *   Данный параметр может принимать одно из следующих значений:
  *   SPI0, SPI1.
  * @param  SPI_InitStruct : указатель на структуру SPI_InitTypeDef, которая
  *   содержит конфигурацию для выбранного номера SPI.
  * @retval Нет
  */
